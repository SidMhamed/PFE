                    ...
                    <tbody>
                        @foreach ($Peripheriques as $Peripherique)
                            <tr>
                                ...
                                <td><a
                                        href="{{ route('Peripherique.edit', $Peripherique->id) }}">{{ $Peripherique->name }}</a>
                                </td>
                                ...
                                <td>{{ App\Models\TypesPeripherique::findOrFail($Peripherique->Peripheriquetypes_id)->name }}
                                </td>
                                <td>{{ App\Models\ModelPeripherique::findOrFail($Peripherique->Peripheriquemodels_id)->name }}
                                </td>
