...
<div class="container align-content-center border-0" role="alert">
        ...
        <div class="card border-0">
            ...
            <div class="card-body">
                 <form action="{{route('AjouterLogiciels')}}" method="POST">
                 @csrf
 ...
 {{-- model pour les Fabricants--}}
   <div class="modal fade my-5" id="Fabricants" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
