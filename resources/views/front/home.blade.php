    ...
    <div class="row">
        ...
        <div class="col-md-8 offset-md-2">
                <h3 class="alert-heading text-white mx-2">{{ __('Tableau de bord') }}</h3>
                    <div class="row">
                        <a href="{{ route('showComputer') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Ordina home">
                                    <span class="text-left float-auto" title="{{ $countComputer }}" style="font-size:2.2em;color:#8c2121">{{$countComputer}}</span>
                                   <i class="fa-fw fas fa-laptop float-right" title="Ordinateur" style="font-size:2em;color:#8c2121"></i><br>
                                   <h6 class="text-left" title="Ordinatuer" style="color:#8c2121">Ordinateurs</h6>
                        </a>
                        <a href="{{ route('Materiel_Reseau') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert materiel-r home">
                        ...
                        <a href="{{ route('Imprimante.index') }}" id="circle-b" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Impri home">
                        ...
                        <a href="{{ route('Telephone.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Tel home">
                        ...
                        <a href="{{ route('Moniteur.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Moniteur home">
                        ...
                        <a href="{{ route('Peripherique.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert usb home">
                         ...
                         <a href="{{route('Logiciels')}}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Logiciel home">
                            <span class="text-left float-left" title="{{$Logiciel}}" data-precision="0" style="font-size:2.2em;">{{$Logiciel}}</span>
                            <i class="fas fa-cube float-right" title="Logiciel" style="font-size:2em;"></i><br><br>
                            <h6 class="text-left" title="Logiciel">Logiciel</h6>
                        </a>
                        <a href="{{route('CarteSIM.index')}}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert carte home">
