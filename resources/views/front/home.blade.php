            ...
            <div class="card border-0">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <a href="{{ route('Materiel_Reseau') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert materiel-r">
                        ...
                        <a href="{{ route('Imprimante.index') }}" id="circle-b" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Impri">
                        ...
                        <a href="{{ route('Telephone.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Tel">
                        ...
                        <a href="{{ route('Moniteur.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Moniteur">
                        ...
                        <a href="{{ route('Peripherique.index') }}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert usb">
                         ...
                         <a href="{{route('Logiciels')}}" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Logiciel">
                        ...
                        <a href="#" class="col-md-3 py-0  px-0 mx-1 text-decoration-none alert Materiel_B">
