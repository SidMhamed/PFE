                ...
                <tbody>
                    <tr class="">
                        <td class="center text-center" width="100%">
                            <h5 class="text-center text-white float-left">Total : <span id="total_records"></span></h5>
                        </td>
                        <td class="left" width="100%">
                            <a href="{{ route('MaterielBureau.create') }}" class="btn btn-success px-2">
            ...
            <div class="center">
                <table class="tab_cadrehov table text-center">
                    <thead>
                        <tr class="bg-white">
                            <th><a href="#">Nom</a></th>
                            <th><a href="#">Couluer</a></th>
                            <th><a href="#">Matricule</a></th>
                            <th><a href="#">Fabricant</a></th>
                            <th><a href="#">Lieu</a></th>
                            <th><a href="#">Dernière modification</a></th>
                        </tr>
                    </thead>
                    <tbody id="tbodyMaterielBureau">
                ...
                function fetch_customer_data(query = '') {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#tbodyMaterielBureau').html(data.table_data);
