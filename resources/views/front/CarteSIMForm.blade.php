...
<div class="container align-content-center border-0" role="alert">
        ...
        <div class="card border-0">
            ...
            <div class="card-body">
                 <form action="{{route('AjouterCarteSIM')}}" method="POST">
                 @csrf
                       ...
                       <tr>
                        ...
                        <td>
                            ...
                            <td>
                                    ...
                                    <i class="fa fa-plus-circle mx-1" title="Ajouter" data-toggle="modal" data-target="#composant"></i>
                            </td>
                       </tr>
                       <tr>
                        <td>
 ...
 {{-- model pour les Fabricants--}}
   <div class="modal fade" id="composant" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
