                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="Nom" class="form-control" placeholder=""
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="UsaNum" id="UsaNum" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                                <label for="Usager">Usager</label>
                                <input type="text" name="Usager" id="Usager" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="UUID" id="UUID" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                            </div>
                            <div class="form-group">
