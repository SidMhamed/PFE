...
@section('content')
        <div class="container align-content-center border-0">
            ...
            <div id="card" class="card border-0">
                ...
                <div class="card-body">
                    <form action="{{route('updateComputer',$Computer->id)}}" method="PUT">
                     <table class="tab_cadre_fixe">
                        <tr>
                            ...
                            <option value="{{$Computer->Locations_id ?? $Location->id}}">{{App\Models\glpi_location::findOrFail($Computer->Locations_id)->name ?? $Location->name}}</option>
                            @endforeach --}}
                            </select>
