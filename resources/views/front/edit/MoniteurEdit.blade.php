...
<div class="container align-content-center border-0" role="alert">
                 ...
                 {{ csrf_field() }}
                    <table class="tab_cadre_fixe">
                       <tr>
                        ...
                        <td>
                        <input type="text" id="name" value="{{$Moniteur->name ?? ''}}"  class="" name="name" required>
                        </td>
                        <td>
                       ...
                       <tr>
                        ...
                        <td>
                                    ...
                                    <i class="fa fa-plus-circle mx-1" title="Ajouter" data-toggle="modal" data-target="#TypeMoniteur"></i>
                        </td>
                       </tr>
                       <tr>
                        <td>
                       ...
                       <td>
                            ...
                            <td>
                                    ...
                                    <i class="fa fa-plus-circle mx-1" title="Ajouter" data-toggle="modal" data-target="#ModaleMoniteur"></i>
                            </td>
                       </tr>
                       <tr>
                         <td>
                            ...
                            <td>
                                    <input type="text" name="UsagerNumero" value="{{$Moniteur->UsagerNumero ?? ''}}" id="UsaNum" class="" required placeholder="" aria-describedby="helpId">
                            </td>
                        <td>
                                    <label for="NumSerie">Numéro de Série</label>
                            </td>
                            <td>
                                    <input type="text" name="numeroDeSerie" value="{{$Moniteur->numeroDeSerie ?? ''}}"  id="NumSerie" class="" required>
                            </td>
                       </tr>
                        <tr>
                       <td>
                            ...
                            <td>
                                    <input type="text" name="Usager" value="{{$Moniteur->Usager ?? ''}}"  id="Usager" class="" required placeholder="" aria-describedby="helpId">
                            </td>
                         <td>
                                <label for="NumDinventaire">Numéro de d'inventaire</label>
                            </td>
                            <td>
                                <input type="text" name="NumeroDinventaire" value="{{$Moniteur->NumeroDinventaire ?? ''}}" id="NumDinventaire" class="" required>
                            </td>
                       </tr>
                     <tr>
                       <td>
                     ...
                     <tr>
                        <td>
                         ...
                         <td  rowspan="3">
                                    <textarea name="comment" value="{{$Moniteur->comment}}" id="comment" cols="40" rows="5" class="" required></textarea>
                         </td>
                     </tr>
                     <tr>
                        <td>
 ...
 {{-- model pour le types des Ordinateurs--}}
    <div class="modal fade" id="TypeMoniteur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade" id="ModaleMoniteur" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
