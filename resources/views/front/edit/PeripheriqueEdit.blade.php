                   ...
                   {{ csrf_field() }}
                    <table class="tab_cadre_fixe">
                       <tr>
                        ...
                        <td>
                        <input type="text" id="name" class="" name="name" value="{{$Peripherique->name ?? ''}}" required>
                        </td>
                        <td>
                       ...
                       <tr>
                         <td>
                            ...
                            <td>
                                    <input type="text" name="UsagerNumero" value="{{$Peripherique->UsagerNumero ?? ''}}" id="UsaNum" class="" required placeholder="" aria-describedby="helpId">
                            </td>
                        <td>
                                    <label for="NumSerie">Numéro de Série</label>
                            </td>
                            <td>
                                    <input type="text" name="numeroDeSerie" value="{{$Peripherique->numeroDeSerie ?? ''}}" id="NumSerie" class="" required>
                            </td>
                       </tr>
                        <tr>
                       <td>
                            ...
                            <td>
                                    <input type="text" name="Usager" value="{{$Peripherique->Usager ?? ''}}" id="Usager" class="" required placeholder="" aria-describedby="helpId">
                            </td>
                         <td>
                                <label for="NumDinventaire">Numéro de d'inventaire</label>
                            </td>
                            <td>
                                <input type="text" name="NumeroDinventaire" value="{{$Peripherique->NumeroDinventaire ?? ''}}" id="NumDinventaire" class="" required>
                            </td>
                       </tr>
                     <tr>
                       <td>
                     ...
                     <tr>
                        <td>
                         ...
                         <td  rowspan="2">
                                    <textarea name="comment" value="{{$Peripherique->comment ?? ''}}" v id="comment" cols="35" rows="3" class="" required></textarea>
                         </td>
                     </tr>
                     <tr>
                        <td>
                        ...
                        <td>
                        <input type="text" class="" name="Marque" value="{{$Peripherique->Marque ?? ''}}" id="marque">
                        </td>
                     </tr>
