                ...
                <form action="{{ route('MaterielBureau.store') }}" method="POST">
                    ...
                    <table class="tab_cadre_fixe">
                        <tr>
                            ...
                            <td>
                                <input type="text" id="name" class="form-control" value="{{ $MaterielBureau->name ?? '' }}" name="name" required>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td rowspan="4">
                                <textarea name="comment" id="comment" cols="50" rows="4" class="form-control" required>
                                    {{ $MaterielBureau->comment ?? '' }}
                                </textarea>
                            </td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td>
                               <input name="matricule" type="text" value="{{ $MaterielBureau->matricule }}" id="matricule" class="form-control">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input name="color" type="text" value="{{ $MaterielBureau->color }}" id="color" class="form-control">
                            </td>
                        </tr>
                        <tr class="alert alert-dark">
                            <th colspan="2">
                                Créé le {{ $MaterielBureau->created_at }}
                            </th>
                            <th colspan="2">
                                Dernière mise à jour le {{ $MaterielBureau->updated_at }}
                            </th>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td class="text-center">
                                <form method="POST" action="{{ route('MaterielBureau.destroy', $MaterielBureau->id) }}">
