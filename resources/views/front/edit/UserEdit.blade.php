                 ...
                 {{ csrf_field() }}
                    <table class="tab_cadre_fixe">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="fieldlist" name="fieldlist" value="{{$User->fieldlist ?? ''}}" class=""> </td>
                        </tr>
                        <tr>
                            <td><label for="last_login">Prénom</label></td>
                            <td><input type="text" name="Plast_login" value="{{$User->Plast_login ?? ''}}" id="last_login"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="dateD" value="{{$User->dateD ?? ''}}" id="dateD" class="form-control"></td>
                        ...
                        <tr>
                          ...
                          <td colspan="3"><input type="tel" value="{{$User->phone ?? ''}}" name="phone" id="phone"></td>
                        </tr>
                        <tr>
                        ...
                        <td><input type="text" id="matricule" value="{{$User->matricule ?? ''}}" name="matricule"></td>
                        </tr>
                        <tr>
