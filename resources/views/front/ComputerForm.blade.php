                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <select name="autoupdatesystems_id" id="SMJ" class="form-control" required>
                                    <option hidden value="" selected disabled>-----</option>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="computertypes_id" id="Type" class="form-control" required>
                                        <option hidden value="" selected disabled>-----</option>
                            ...
                            <div class="form-group">
                                ...
                                <select name="computermodels_id" id="model" class="form-control" required>
                                        <option hidden value="" selected disabled>-----</option>
